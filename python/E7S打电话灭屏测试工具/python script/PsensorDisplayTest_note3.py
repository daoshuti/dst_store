...
COM_PORT = 'COM37'
DOWNLOAD_TIMEOUT = 5
DEVICE_ID_OF_THE_L_SENSOR_PHONE = '3d40777'
DEVICE_ID_OF_THE_TESTED_PHONE = '698c808'
...
if __name__ == '__main__':
	...
	while (cur_num_of_test < TOTAL_NUM_OF_TESTS):
		...
		if (1.0 > getLightData()):
			...
			time.sleep(1)
			adb_command('shell input swipe 540 1800 540 800 500')
		#adb_command('shell service call phone 1 s16 "112"')
		#adb_command('shell input swipe 540 1800 540 1810 500')
		# Loop test the P-sensor
		loopTest(10)
		# End the call
		output_log('End the call')
		#db_command('shell input tap 540 1800')
		# Close the shutter
		ser.write("PWM_0\r\n")
		serial_recv = ser.readline()
		output_log('Close the shutter ' + serial_recv)
